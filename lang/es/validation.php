...
/*
|--------------------------------------------------------------------------
| Mensajes de validación (RF-C1, traducción estándar Laravel 11)
|--------------------------------------------------------------------------
| Los mensajes custom por regla+campo van en los propios validate() de los
| componentes; esto cubre el default del framework (antes salía en inglés).
*/
...
return [
    ...
    'ascii' => 'El campo :attribute solo puede contener caracteres alfanuméricos y símbolos simples.',
    ...
    'password' => [
        ...
        'uncompromised' => 'El :attribute ingresado apareció en una filtración de datos. Elegí otro distinto.',
    ],
