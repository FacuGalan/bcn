...
- ABM en GestionarProveedores: repetidor impuesto (catálogo
...
- La computabilidad de percepciones IIBB por jurisdicción/CM sigue BLOQUEADA
  por la respuesta del contador (no codear antes).
