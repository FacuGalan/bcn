...
CREATE TABLE `{{PREFIX}}cierres_turno` (
  ...
  `total_puntos_canjeados_pago` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Puntos consumidos como medio de pago en el turno (snapshot)',
  `total_puntos_canjeados_articulos` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Puntos consumidos en canje directo de articulos en el turno (snapshot)',
  `total_puntos_acumulados` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Puntos generados por ventas del turno (snapshot)',
  `observaciones` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `{{PREFIX}}cierre_turno_cajas` (
  ...
  `desglose_internos` text COLLATE utf8mb4_unicode_ci COMMENT 'JSON con desglose de pagos que NO afectan caja (canje puntos, FPs solo_sistema). Trazabilidad sin sumar a total_ingresos',
  `observaciones` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `{{PREFIX}}movimientos_cuenta_corriente` (
  ...
  `usuario_id` bigint(20) unsigned NOT NULL,
  `moneda_id` bigint(20) unsigned DEFAULT NULL COMMENT 'FK logico a monedas. NULL = moneda principal implicita',
  `tipo_cambio_id` bigint(20) unsigned DEFAULT NULL COMMENT 'FK logico a tipos_cambio.id (sin constraint). Snapshot del registro de cotizacion usado',
...
CREATE TABLE `{{PREFIX}}sucursales` (
  ...
  `pedido_mostrador_ultimo_numero` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Contador correlativo de pedidos por mostrador (reset manual con permiso)',
...
CREATE TABLE `{{PREFIX}}ventas` (
  ...
  `descuento_general_aplicado_por` bigint(20) unsigned DEFAULT NULL COMMENT 'Auditoria: user.id que aplico el descuento general (FK logico cross-DB a config.users)',
  ...
  `puntos_canjeados_pago` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Puntos usados como medio de pago en la venta',
  `puntos_canjeados_articulos` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Puntos usados en canje directo de articulos en la venta',
...
CREATE TABLE `{{PREFIX}}ventas_detalle` (
  ...
  `ajuste_manual_aplicado_por` bigint(20) unsigned DEFAULT NULL COMMENT 'Auditoria: user.id que aplico el ajuste manual (FK logico cross-DB a config.users)',
...
CREATE TABLE `{{PREFIX}}venta_pago_ajustes` (
  ...
  `venta_id` bigint(20) unsigned NOT NULL,
  `sucursal_id` bigint(20) unsigned NOT NULL,
  `tipo_operacion` enum('cambio_pago','agregar_pago','eliminar_pago') COLLATE utf8mb4_unicode_ci NOT NULL,
  `venta_pago_anulado_id` bigint(20) unsigned DEFAULT NULL COMMENT 'NULL si es agregar_pago',
  `venta_pago_nuevo_id` bigint(20) unsigned DEFAULT NULL COMMENT 'NULL si es eliminar_pago',
  `forma_pago_anterior_id` bigint(20) unsigned DEFAULT NULL,
  `forma_pago_nueva_id` bigint(20) unsigned DEFAULT NULL,
  ...
  `turno_original_id` bigint(20) unsigned DEFAULT NULL COMMENT 'cierre_turno_id del pago anulado',
  `es_post_cierre` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'true si afectó turno cerrado',
  `nc_emitida_id` bigint(20) unsigned DEFAULT NULL,
  `fc_nueva_id` bigint(20) unsigned DEFAULT NULL,
...
CREATE TABLE `{{PREFIX}}venta_pagos` (
  ...
  `integracion_pago_transaccion_id` bigint(20) unsigned DEFAULT NULL COMMENT 'FK a integraciones_pago_transacciones - cobro de integracion (QR MP) que pago este registro',
  `monto_facturado` decimal(12,2) DEFAULT NULL,
  `anulado_por_usuario_id` bigint(20) unsigned DEFAULT NULL,
  `anulado_at` timestamp NULL DEFAULT NULL,
  `motivo_anulacion` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `venta_pago_reemplazado_id` bigint(20) unsigned DEFAULT NULL COMMENT 'FK al venta_pago que este reemplaza (cambio de pago)',
  `operacion_origen` enum('venta_original','cambio_pago','pago_agregado','anulacion_sin_reemplazo') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'venta_original' COMMENT 'Origen del registro: alta de venta o ajuste posterior',
  `creado_por_usuario_id` bigint(20) unsigned DEFAULT NULL COMMENT 'FK a config.users - usuario que creó este registro (si distinto del de la venta)',
  `nota_credito_generada_id` bigint(20) unsigned DEFAULT NULL COMMENT 'FK a comprobantes_fiscales - NC disparada por la anulación de este pago',
  `comprobante_fiscal_nuevo_id` bigint(20) unsigned DEFAULT NULL COMMENT 'FK a comprobantes_fiscales - FC nueva emitida al reemplazar este pago',
  `datos_snapshot_json` longtext COLLATE utf8mb4_unicode_ci COMMENT 'Snapshot JSON del pago al momento de anularse (forense)',
  `estado_facturacion` enum('no_facturado','facturado','pendiente_de_facturar','error_arca') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'no_facturado' COMMENT 'Estado de facturación del pago: no_facturado|facturado|pendiente_de_facturar|error_arca',
  `cierre_turno_id` bigint(20) unsigned DEFAULT NULL COMMENT 'Cierre de turno donde se procesó este pago',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `moneda_id` bigint(20) unsigned DEFAULT NULL,
  `monto_moneda_original` decimal(14,2) DEFAULT NULL,
  `tipo_cambio_tasa` decimal(14,6) DEFAULT NULL,
  `tipo_cambio_id` bigint(20) unsigned DEFAULT NULL COMMENT 'FK logico a tipos_cambio.id (sin constraint por convencion multi-tenant). Snapshot del registro de cotizacion usado',
  `movimiento_cuenta_empresa_id` bigint(20) unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `{{PREFIX}}pedidos_mostrador` (
  ...
  `numero_display` int(10) unsigned DEFAULT NULL COMMENT 'Numero amigable mostrado (monitor/comanda/kanban)',
