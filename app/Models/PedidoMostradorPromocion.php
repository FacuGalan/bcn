...
/**
 * Modelo PedidoMostradorPromocion
 *
 * Promocion aplicada a nivel pedido (no a item especifico). Espejo de
 * VentaPromocion.
 */
class PedidoMostradorPromocion extends Model
{
    protected $connection = 'pymes_tenant';

    protected $table = 'pedido_mostrador_promociones';
