...
/**
 * Modelo PedidoMostradorDetallePromocion
 *
 * Promocion aplicada a una linea de pedido (a nivel item). Espejo de
 * VentaDetallePromocion.
 */
class PedidoMostradorDetallePromocion extends Model
{
    protected $connection = 'pymes_tenant';

    protected $table = 'pedido_mostrador_detalle_promociones';
