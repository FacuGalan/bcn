...
Cuando la sucursal acepta pedidos externos (tienda/API) de forma **manual**, aparece una franja destacada con los pedidos que llegaron sin confirmar todavia. La franja arranca **plegada** por defecto: la cabecera muestra un contador pulsante ("N por aceptar") y, si algun pedido supera el tiempo configurado sin aceptarse, un badge rojo **"Demorado"** visible aunque este plegada. Un click en la cabecera la despliega y muestra el listado completo.

Un pedido externo nuevo (borrador) aparece en la franja **al instante**, sin necesidad de refrescar la pagina, con un destello visual en el borde de la cabecera durante unos segundos para llamar la atencion.

Cada pedido por aceptar del listado desplegado muestra:
