                    ...
                    @if($grupo)
                        <div class="mb-4 p-3 bg-indigo-50 dark:bg-indigo-900/20 rounded-lg">
                            ...
                            <p class="text-xs text-indigo-600 dark:text-indigo-400 mt-1">
                                {{ $grupo['cantidad_cajas'] }} cajas con fondo en comun
                            </p>
                        </div>

                        {{-- Lista de cajas del grupo --}}
                        <div class="mb-4">
                            <p class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Cajas que se abriran:</p>
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                                Este monto sera el fondo compartido por todas las cajas del grupo
                            </p>
                        </div>
                    @endif
                    ...
                    @if($grupo)
                        <div class="mb-4 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                            ...
                            <p class="text-xs text-blue-600 dark:text-blue-400 mt-1">
                                {{ $grupo['cantidad_cajas'] }} cajas con fondos individuales
                            </p>
                        </div>
                                    ...
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                                            ...
                                            @if($cajaInfo['modo_carga'] === 'monto_fijo')
                                                <span class="text-xs text-gray-500">(Monto fijo)</span>
                                            @elseif($cajaInfo['modo_carga'] === 'ultimo_cierre')
                                                <span class="text-xs text-gray-500">(Ultimo cierre)</span>
                                            @endif
                                        </label>
                                        <div class="relative">
                                            <span class="absolute inset-y-0 left-0 pl-3 flex items-center text-gray-500">$</span>
                    ...
                    @if($cajaInfo)
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                                Fondo Inicial
                                @if($cajaInfo['modo_carga'] === 'monto_fijo')
                                    <span class="text-xs text-gray-500">(Monto fijo configurado)</span>
                                @elseif($cajaInfo['modo_carga'] === 'ultimo_cierre')
                                    <span class="text-xs text-gray-500">(Segun ultimo cierre)</span>
                                @endif
                            </label>
                            <div class="relative">
                                <span class="absolute inset-y-0 left-0 pl-3 flex items-center text-gray-500">$</span>
