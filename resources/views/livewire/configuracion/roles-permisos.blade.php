    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="mb-6 flex justify-between items-center">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-600">Administra los roles y sus permisos de acceso al menú</p>
            </div>
            <button
                wire:click="create"
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
            <div class="p-6">
                <label for="search" class="block text-sm font-medium text-gray-700 mb-1">Buscar rol</label>
                <input
                    type="text"
                    id="search"
                    wire:model.live.debounce.300ms="search"
                    placeholder="Nombre del rol..."
                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-bcn-primary focus:ring focus:ring-bcn-primary focus:ring-opacity-50"
                />
            </div>
        </div>
                    ...
                    <div class="p-6">
                        ...
                        <div class="mt-4 flex space-x-2">
                            <button
                                ...
                                class="flex-1 inline-flex justify-center items-center px-3 py-2 border border-bcn-primary text-sm font-medium rounded-md text-bcn-primary hover:bg-bcn-primary hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-bcn-primary transition-colors duration-150"
                            >
                            ...
                            @if($role->name !== 'Super Administrador')
                                <button
                                    ...
                                    class="inline-flex justify-center items-center px-3 py-2 border border-red-300 text-sm font-medium rounded-md text-red-700 hover:bg-red-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-colors duration-150"
                                >
                            ...
                            <div class="sm:flex sm:items-start">
                                <div class="w-full mt-3 text-center sm:mt-0 sm:text-left">
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        <!-- Permisos de menú -->
                                        <div>
                                            <label class="block text-sm font-medium text-gray-700 mb-3">Permisos de acceso al menú</label>
                                                ...
                                                @foreach($groupedPermissions as $moduleName => $permissions)
                                                    <div class="border-b border-gray-200 pb-3 last:border-b-0">
                                                        ...
                                                        <div class="flex items-center mb-2">
                                                            ...
                                                            />
                                                            <label for="perm_{{ $permissions['parent']->id }}" class="ml-2 text-sm font-semibold text-gray-900">
                                                                {{ $moduleName }}
                                                            </label>
                                                        </div>
                                                                ...
                                                                @foreach($permissions['children'] as $childPermission)
                                                                    <div class="flex items-center">
                                                                        <input
                                                                            ...
                                                                            class="rounded border-gray-300 text-bcn-primary focus:ring-bcn-primary"
                                                                        />
                                                                        <label for="perm_{{ $childPermission->id }}" class="ml-2 text-sm text-gray-700">
