...
<div class="p-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
        <div>
            <h3 class="text-lg font-medium text-gray-900 dark:text-white">CUITs Registrados</h3>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                Administra los CUITs para facturación electrónica
            </p>
        </div>
        <button
                    ...
                    <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <div class="mt-2 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-2 text-sm">
                                <div>
                                    <span class="text-gray-500 dark:text-gray-400">CUIT:</span>
                                    <span class="ml-1 text-gray-900 dark:text-white font-mono">{{ $cuit->cuit_formateado }}</span>
                                </div>
                                <div>
                                    <span class="text-gray-500 dark:text-gray-400">Cond. IVA:</span>
                                    <span class="ml-1 text-gray-900 dark:text-white">{{ $cuit->condicionIva?->nombre ?? '-' }}</span>
                                </div>
                                <div>
                                    <span class="text-gray-500 dark:text-gray-400">IIBB:</span>
                                ...
                                <div>
                                    <span class="text-gray-500 dark:text-gray-400">Localidad:</span>
                            ...
                            @if($cuit->puntosVenta->count() > 0)
                                <div class="mt-4 pt-4 border-t border-gray-200 dark:border-gray-600">
                                    <h5 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                        Puntos de Venta ({{ $cuit->puntosVenta->count() }})
                                    </h5>
    ...
    @else
        ...
        <div class="text-center py-12">
            ...
            <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-white">No hay CUITs registrados</h3>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                Comienza agregando un CUIT para poder emitir facturas electrónicas.
            </p>
            <div class="mt-6">
                <button
                    wire:click="crearCuit"
