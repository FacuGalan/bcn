    ...
    <div class="px-4 sm:px-6 lg:px-8">
        ...
        @if($showModal)
            ...
            >
                <x-slot:body>
                    <div class="space-y-6">
                        {{-- RF-T43: cliente vinculado a una cuenta BCN de la tienda online --}}
                        @if($editMode && $cuenta_bcn_email)
                            <div class="flex items-center gap-2 rounded-lg bg-indigo-50 dark:bg-indigo-900/30 px-3 py-2 text-sm text-indigo-700 dark:text-indigo-300">
                                ...
                                <span>{{ __('Cuenta BCN de la tienda online:') }} <strong>{{ $cuenta_bcn_email }}</strong></span>
                            </div>
                        @endif
