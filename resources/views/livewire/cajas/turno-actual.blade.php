<div class="py-4 px-4 sm:px-6">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Turno Actual</h1>
            <p class="text-sm text-gray-500 dark:text-gray-400">
                Gestion de cajas y movimientos del turno
            </p>
        </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-5 mb-6">
        <div class="flex items-center justify-between mb-4">
            ...
            <div class="flex items-center gap-2 text-sm">
                <span class="inline-flex items-center px-2.5 py-1 rounded-full bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400">
                    ...
                    {{ $totalesGenerales['cajasAbiertas'] ?? 0 }} activas
                </span>
                ...
                <span class="inline-flex items-center px-2.5 py-1 rounded-full bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400">
                    ...
                    {{ $totalesGenerales['cajasPausadas'] }} pausadas
                </span>
                @endif
                ...
                <span class="inline-flex items-center px-2.5 py-1 rounded-full bg-gray-100 text-gray-600 dark:bg-gray-700 dark:text-gray-400">
                    {{ $totalesGenerales['cajasCerradas'] }} sin turno
                </span>
                @endif
            </div>
        </div>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
            <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
                <p class="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wider">Fondo Inicial</p>
            ...
            <div class="bg-green-50 dark:bg-green-900/20 rounded-lg p-4">
                <p class="text-xs text-green-600 dark:text-green-400 uppercase tracking-wider">Ingresos</p>
            ...
            <div class="bg-red-50 dark:bg-red-900/20 rounded-lg p-4">
                <p class="text-xs text-red-600 dark:text-red-400 uppercase tracking-wider">Egresos</p>
                <p class="text-xl font-bold text-red-700 dark:text-red-300 mt-1">-${{ number_format($totalesGenerales['egresos'] ?? 0, 2, ',', '.') }}</p>
            </div>
            <div class="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4">
                <p class="text-xs text-blue-600 dark:text-blue-400 uppercase tracking-wider">Saldo Actual</p>
            ...
            <div class="bg-purple-50 dark:bg-purple-900/20 rounded-lg p-4">
                <p class="text-xs text-purple-600 dark:text-purple-400 uppercase tracking-wider">Operaciones</p>
                <p class="text-xl font-bold text-purple-700 dark:text-purple-300 mt-1">{{ $totalesGenerales['operaciones'] ?? 0 }}</p>
            </div>
            <div class="bg-amber-50 dark:bg-amber-900/20 rounded-lg p-4">
                <p class="text-xs text-amber-600 dark:text-amber-400 uppercase tracking-wider">Movimientos</p>
        ...
        <div class="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
            <p class="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">Por Concepto de Pago</p>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-8 text-center">
        ...
        <h3 class="mt-2 text-lg font-medium text-gray-900 dark:text-white">No hay cajas disponibles</h3>
        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">No tienes cajas asignadas o todas estan cerradas.</p>
    </div>
    @else
                ...
                <div class="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="flex items-center justify-between mb-4 pb-4 border-b border-gray-200 dark:border-gray-700">
                        <div>
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400">
                                @if($esAperturaGrupal)
                                    Apertura grupal - {{ count($cajasAAbrir) }} cajas
                                @else
                                    Apertura individual
                                @endif
                            </p>
                    ...
                    <div class="space-y-4">
                        ...
                        @if($esAperturaGrupal && $grupoUsaFondoComun)
                            ...
                            <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                                <div class="flex items-center mb-3">
                                    ...
                                    <h4 class="font-semibold text-blue-900 dark:text-blue-300">
                                        Fondo Comun del Grupo
                                    </h4>
                                </div>
                                <p class="text-sm text-blue-700 dark:text-blue-400 mb-3">
                                    Este grupo utiliza fondo comun. El monto ingresado sera compartido entre las {{ $grupoInfo['cantidad_cajas'] ?? count($cajasAAbrir) }} cajas.
                                </p>
                                <div>
                            ...
                            <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
                                <h5 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Cajas que se abriran:</h5>
                                <div class="flex flex-wrap gap-2">
                                    ...
                                    <span class="text-xs px-2 py-1 rounded bg-gray-200 dark:bg-gray-600 text-gray-600 dark:text-gray-300">
                                        @switch($cajaApertura['modo_carga'])
                                            @case('ultimo_cierre')
                                                ...
                                                @break
                                            @case('monto_fijo')
                                                Auto (${{ number_format($cajaApertura['monto_fijo'], 0) }})
                                                @break
                                            @default
                                                Manual
                                        @endswitch
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">
                            @if($esCierreGrupal)
                                Cierre grupal - {{ count($cajasACerrar) }} cajas
                            @else
                                Cierre individual
                            @endif
                        </p>
                        ...
                        <div class="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-5 border border-blue-200 dark:border-blue-700">
                            ...
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <span class="text-sm text-gray-500 dark:text-gray-400">
                                    {{ $datosConsolidados['cantidad_cajas'] }} cajas
                                </span>
                            </div>
                            ...
                            <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-5">
                                <div class="bg-white dark:bg-gray-800 rounded-lg p-3 text-center border border-gray-100 dark:border-gray-600">
                                    <p class="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wide">Fondo Inicial</p>
                                    <p class="text-lg font-bold text-gray-900 dark:text-white mt-1">${{ number_format($datosConsolidados['fondo_inicial'], 2, ',', '.') }}</p>
                                </div>
                                <div class="bg-white dark:bg-gray-800 rounded-lg p-3 text-center border border-gray-100 dark:border-gray-600">
                                    <p class="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wide">Ingresos Total</p>
                                    <p class="text-lg font-bold text-green-600 dark:text-green-400 mt-1">+${{ number_format($datosConsolidados['total_ingresos'], 2, ',', '.') }}</p>
                                </div>
                                <div class="bg-white dark:bg-gray-800 rounded-lg p-3 text-center border border-gray-100 dark:border-gray-600">
                                    <p class="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wide">Egresos Total</p>
                                ...
                                <div class="bg-blue-100 dark:bg-blue-900/50 rounded-lg p-3 text-center border border-blue-300 dark:border-blue-600">
                                    <p class="text-xs text-blue-700 dark:text-blue-300 uppercase tracking-wide font-medium">Saldo Sistema</p>
                            ...
                            <div class="mb-5">
                                <p class="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-2">Detalle por Caja</p>
                                <div class="flex flex-wrap gap-2">
                            ...
                            <div class="bg-white dark:bg-gray-800 rounded-xl p-4 border-2 border-blue-300 dark:border-blue-600">
                                <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
                                    Efectivo Total Contado (Arqueo del Fondo Com&uacute;n)
                                </label>
                                <div class="relative">
                                    ...
                                    <input
                                        ...
                                        placeholder="Ingrese el total del efectivo"
                                    >
                                </div>

                                {{-- C&aacute;lculo de diferencia --}}
                                @php
                                ...
                                <div class="mt-3 p-3 rounded-xl text-center {{ $diferenciaFC == 0 ? 'bg-green-100 dark:bg-green-900/40 border border-green-300 dark:border-green-700' : ($diferenciaFC > 0 ? 'bg-amber-100 dark:bg-amber-900/40 border border-amber-300 dark:border-amber-700' : 'bg-red-100 dark:bg-red-900/40 border border-red-300 dark:border-red-700') }}">
                                    <div class="flex items-center justify-center space-x-2">
                                        @if($diferenciaFC == 0)
                                            ...
                                            <span class="text-lg font-bold text-green-700 dark:text-green-400">Fondo Cuadrado</span>
                                        @elseif($diferenciaFC > 0)
                                            <svg class="w-5 h-5 text-amber-600 dark:text-amber-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/>
                                            </svg>
                                            <span class="text-lg font-bold text-amber-700 dark:text-amber-400">Sobrante: +${{ number_format($diferenciaFC, 2, ',', '.') }}</span>
                                        @else
                                            <svg class="w-5 h-5 text-red-600 dark:text-red-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                            </svg>
                                            <span class="text-lg font-bold text-red-700 dark:text-red-400">Faltante: -${{ number_format(abs($diferenciaFC), 2, ',', '.') }}</span>
                                        @endif
                                    </div>
                                </div>
                                @else
                                <p class="mt-3 text-sm text-center text-gray-500 dark:text-gray-400">
                                    Ingrese el efectivo total contado para calcular la diferencia
                                </p>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-5 border border-gray-200 dark:border-gray-600">
                            ...
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <span class="text-xs text-gray-500 dark:text-gray-400">
                                    Abierta: {{ $cajaCierre['fecha_apertura'] }}
                                </span>
                                @endif
                            </div>
                            ...
                            <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-5">
                                ...
                                <div class="bg-white dark:bg-gray-800 rounded-lg p-3 text-center border border-gray-100 dark:border-gray-600">
                                    <p class="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wide">Egresos</p>
                                ...
                                <div class="bg-blue-50 dark:bg-blue-900/30 rounded-lg p-3 text-center border border-blue-200 dark:border-blue-700">
                                    <p class="text-xs text-blue-600 dark:text-blue-400 uppercase tracking-wide font-medium">Saldo Sistema</p>
                                ...
                                <div class="mt-3 p-3 rounded-xl text-center {{ $diferencia == 0 ? 'bg-green-100 dark:bg-green-900/40 border border-green-300 dark:border-green-700' : ($diferencia > 0 ? 'bg-amber-100 dark:bg-amber-900/40 border border-amber-300 dark:border-amber-700' : 'bg-red-100 dark:bg-red-900/40 border border-red-300 dark:border-red-700') }}">
                                    <div class="flex items-center justify-center space-x-2">
                                        @if($diferencia == 0)
                                            ...
                                            <span class="text-lg font-bold text-green-700 dark:text-green-400">Caja Cuadrada</span>
                                        @elseif($diferencia > 0)
                                            <svg class="w-5 h-5 text-amber-600 dark:text-amber-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/>
                                            </svg>
                                            <span class="text-lg font-bold text-amber-700 dark:text-amber-400">Sobrante: +${{ number_format($diferencia, 2, ',', '.') }}</span>
                                        @else
                                            <svg class="w-5 h-5 text-red-600 dark:text-red-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                            </svg>
                                            <span class="text-lg font-bold text-red-700 dark:text-red-400">Faltante: -${{ number_format(abs($diferencia), 2, ',', '.') }}</span>
                                        @endif
                                    </div>
                                </div>
                                @else
