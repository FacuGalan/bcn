<div class="py-4">
    <div class="px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        ...
        {{-- ==================== Aclaraciones (cómo funciona) ==================== --}}
        <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-4 sm:mb-6">
        ...
        {{-- ==================== Formulario ==================== --}}
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-4 sm:p-6 mb-4 sm:mb-6">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                {{-- Archivo --}}
                <div>
                    <label class="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">{{ __('Archivo de padrón (.txt)') }}</label>
                    <input type="file" wire:model="archivo" accept=".txt,.csv,text/plain"
                    ...
                    <div wire:loading wire:target="archivo" class="mt-1 text-xs text-gray-500 dark:text-gray-400">{{ __('Subiendo archivo…') }}</div>
                    @error('archivo') <span class="mt-1 block text-xs text-red-600 dark:text-red-400">{{ $message }}</span> @enderror
                </div>
            </div>
