<div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-6">
    ...
    <form wire:submit="crearCupon" class="space-y-6 max-w-2xl">
        {{-- Tipo de cupón --}}
        <div>
        ...
        <div class="border border-gray-200 dark:border-gray-600 rounded-lg p-4 space-y-3">
            ...
            <div class="relative">
                ...
                <div class="absolute z-10 mt-1 w-full bg-white dark:bg-gray-700 rounded-md shadow-lg border border-gray-200 dark:border-gray-600 max-h-48 overflow-y-auto">
            ...
            <div class="space-y-2">
                ...
                <div class="flex items-center justify-between px-3 py-2 bg-gray-50 dark:bg-gray-600 rounded">
                    <div>
                    ...
                    <button type="button" wire:click="quitarArticulo({{ $artId }})" class="text-red-400 hover:text-red-600">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/>
                        </svg>
                    </button>
        ...
        <div class="flex justify-end space-x-3">
            <button type="button" wire:click="resetFormularioCrear"
