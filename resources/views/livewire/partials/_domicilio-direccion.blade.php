...
{{-- Con referencia visible, dirección y referencia comparten el renglón a mitad
     de ancho; sin referencia, la dirección ocupa el ancho completo. --}}
@if($conDireccion)
    <div class="{{ $conReferencia ? '' : 'sm:col-span-2' }}">
...
@if($conReferencia)
    <div class="{{ $conDireccion ? '' : 'sm:col-span-2' }}">
